...
public class MediabuildController implements Initializable {
	...
	public void about(ActionEvent event){
		...
		alert1.setHeaderText("Image Processing Media Player Help");
		alert1.setContentText("Image Processing Media Player is an open source media player in which you can play any type of media files. ");
